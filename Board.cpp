...
namespace OpenIP {
    Board::Board(char *title, int width, int height, ColorRGB *backGround) : title(title), width(width), height(height), backGround(backGround) {
        ...
        zhongzhi = new PixelMap((this->width / 4), 0, this->width / 4, this->height / 2, new ColorRGB(255, 255, 255));
        for (int i = 0; i < this->width / 4; i++) {
            std::vector<Pixel *> pp;
            for (int j = 0; j < this->height / 2; j++) {
                pp.push_back(new Pixel((this->width / 4) + i, j, new ColorRGB(255, 255, 255)));
            }
        ...
        for (int i = 0; i < this->width / 4; i++) {
            std::vector<Pixel *> pp;
            for (int j = 0; j < this->height / 2; j++) {
                pp.push_back(new Pixel((this->width / 4) * 2 + i, j, new ColorRGB(255, 255, 255)));
            }
        ...
        for (int i = 0; i < this->width / 4; i++) {
            std::vector<Pixel *> pp;
            for (int j = 0; j < this->height / 2; j++) {
                pp.push_back(new Pixel((this->width / 4) * 3 + i, j, new ColorRGB(255, 255, 255)));
            }
        ...
        for (int i = 0; i < this->width / 4; i++) {
            std::vector<Pixel *> pp;
            for (int j = 0; j < this->height / 2; j++) {
                pp.push_back(new Pixel(i, j + this->height / 2, new ColorRGB(255, 255, 255)));
            }
        ...
        for (int i = 0; i < this->width / 4; i++) {
            std::vector<Pixel *> pp;
            for (int j = 0; j < this->height / 2; j++) {
                pp.push_back(new Pixel((this->width / 4) + i, j + this->height / 2, new ColorRGB(255, 255, 255)));
            }
        ...
        for (int i = 0; i < this->width / 4; i++) {
            std::vector<Pixel *> pp;
            for (int j = 0; j < this->height / 2; j++) {
                pp.push_back(new Pixel((this->width / 4) * 2 + i, j + this->height / 2, new ColorRGB(255, 255, 255)));
            }
        ...
        for (int i = 0; i < this->width / 4; i++) {
            std::vector<Pixel *> pp;
            for (int j = 0; j < this->height / 2; j++) {
                pp.push_back(new Pixel((this->width / 4) * 3 + i, j + this->height / 2, new ColorRGB(255, 255, 255)));
            }
